...
public class TiberoCreateTableSqlBuilder {
    ...
    public TiberoCreateTableSqlBuilder(CatalogTable catalogTable, boolean createIndex) {
    ...
    private String buildColumnSql(Column column) {
        ...
        String columnType =
                StringUtils.equalsIgnoreCase(DatabaseIdentifier.TIBERO, sourceCatalogName)
                        ? column.getSourceType()
                        : TiberoTypeConverter.INSTANCE.reconvert(column).getColumnType();
    ...
    private String buildPrimaryKeySql(PrimaryKey primaryKey) {
        ...
        // In Tibero database, the maximum length for an identifier is 30 characters.
