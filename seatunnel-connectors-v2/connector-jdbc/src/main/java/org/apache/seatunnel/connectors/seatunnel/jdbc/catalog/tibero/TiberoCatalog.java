...
import org.apache.seatunnel.common.utils.JdbcUrlUtil.UrlInfo;
import org.apache.seatunnel.connectors.seatunnel.jdbc.catalog.AbstractJdbcCatalog;
import org.apache.seatunnel.connectors.seatunnel.jdbc.catalog.utils.CatalogUtils;
import org.apache.seatunnel.connectors.seatunnel.jdbc.internal.dialect.tibero.TiberoTypeConverter;
import org.apache.seatunnel.connectors.seatunnel.jdbc.internal.dialect.tibero.TiberoTypeMapper;
...
@Slf4j
public class TiberoCatalog extends AbstractJdbcCatalog {
    ...
    protected String getListDatabaseSql() {
        return "SELECT dbname FROM _VT_DATABASE";
    }

    @Override
    protected String getCreateTableSql(
            TablePath tablePath, CatalogTable table, boolean createIndex) {
        return new TiberoCreateTableSqlBuilder(table, createIndex).build(tablePath).get(0);
    }

    protected List<String> getCreateTableSqls(
            TablePath tablePath, CatalogTable table, boolean createIndex) {
        return new TiberoCreateTableSqlBuilder(table, createIndex).build(tablePath);
    }
    ...
    public CatalogTable getTable(String sqlQuery) throws SQLException {
        ...
        return CatalogUtils.getCatalogTable(defaultConnection, sqlQuery, new TiberoTypeMapper());
    }
